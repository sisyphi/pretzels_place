<section id="adoption-fostering" class="">
	...
	<div class="xs:grid xs:grid-cols-6">
		<div class="bg-orange p-8 xs:col-start-1 xs:col-end-6 xs:row-start-1 xs:row-end-1">
			<p class="mx-auto max-w-xs text-center font-poppins text-4xl font-bold text-offwhite xs:max-w-full xs:xs:text-right md:text-5xl"><span><a href="/about-us" class="underline">Start your application ></a></span></p>
		</div>
	</div>
</section>
